...
const udpPort = 5001;
const udpMulticastAddress = "239.100.100.11";
...
// });
  ...
  // Start HTTP server on specific IP
   http.createServer(app).listen(port, "172.32.215.35", () => {
    console.log(`HTTP streaming for ${"channel.id"} at http://${"172.32.215.35"}:${port}/stream.ts`);
  });